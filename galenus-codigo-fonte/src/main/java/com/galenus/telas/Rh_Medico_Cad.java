...
public class Rh_Medico_Cad extends javax.swing.JFrame {

    
    public Rh_Medico_Cad() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(TextField_Nome, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 180, 360, 50));
        ...
        getContentPane().add(TextField_Endereco, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 180, 360, 50));
        ...
        getContentPane().add(TextField_CPF, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 280, 360, 50));
        ...
        getContentPane().add(TextField_Nascimento, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 380, 360, 50));
        ...
        getContentPane().add(TextField_Sexo, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 380, 360, 50));
        ...
        getContentPane().add(TextField_Especialidade, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 480, 360, 50));
        ...
        getContentPane().add(TextField_CRM, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 480, 360, 50));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Rh_Medico_Cad().setVisible(true);
            }
        });
    }
    ...
    private Rh_Medico_Cad telaUnica;
    
    public Rh_Medico_Cad getRhMedicoCad(){
        if(telaUnica == null){
            telaUnica = new Rh_Medico_Cad();
        }
        return telaUnica;
    }
