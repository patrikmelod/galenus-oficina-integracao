...
public class CadastraPaciente extends javax.swing.JFrame {
    ...
    private void getNome(){
        ...
        pac.setEndereco(textFieldEndereco.getText());
        pac.setTelefone(textFieldTelefone.getText());
        //fun.setSexo(textFieldSexo.getText());
        cadCpf(pac);
        pacBd.save(pac);
    }    
          
    private void cadCpf(Paciente pac){
        try{
            pac.setDocumento(textFieldCpf.getText());
        }
